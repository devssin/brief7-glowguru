...
<div class="containner py-10 bg-gray-100">
    ...
    <div class="flex flex-col md:flex-row justify-between md:items-center gap-6">
        ...
        <div class="flex items-center">
            ...
            <div class="relative w-full">
                ...
                <input type="text" id="shopSearch" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#ebbb89] focus:border-[#ebbb89] block w-full pl-10 p-2.5 " placeholder="Search" required>
            </div>
    ...
    <!-- Sorting end -->
    <div id="shopContainer" class="grid md:grid-cols-4 gap-6 mt-10">
        <!-- Single Product -->
        <?php foreach ($data['products'] as $product) : ?>
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow group hover:scale-105 transition duration-150 overflow-hidden">
                ...
                <div class="px-5 pb-5 mt-4">
                    <a href="#">
                        <h5 class="text-md font-semibold tracking-tight "><?= substr($product->name, 0, 40) ?>... (<span class="text-xs text-gray-400"><?=$product->category?></span>)</h5>
                    </a>
